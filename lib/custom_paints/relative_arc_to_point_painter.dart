...
class RelativeArcToPointPainter extends CustomPainter {
  late Offset center;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    relativeArcToPoint(canvas, size);
  }

  void relativeArcToPoint(Canvas canvas, Size size) {
    final arcEnd = Offset(size.width, size.height * 0.9);
    final path = Path()
      ..moveTo(0, size.height * 0.1)
      ..relativeArcToPoint(arcEnd,
